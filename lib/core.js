...
function LogTool(opts) {
  ...
  */
  ...
  //log.clearLog(logOpts) //TODO should be cleared/not based on appConfig?  Is this even that useful?
  self.logger = log.initLog(logOpts)
  //self.log = self.logger.log //just a bit more concice
  self.errLogger = function(msg){ //need this wrapper for handling err events.
